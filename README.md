...
| [`second-brain`](skills/second-brain/SKILL.md) | Segundo cérebro do projeto em um vault Obsidian versionado com o código: consulta casos, problemas conhecidos e decisões **antes** de investigar, e registra o que descobriu **depois**, com data e wiki-links. Na primeira execução cria o vault (estrutura, índice, templates) e oferece instalar o Obsidian. |
